 ...
 */
function flattenObjectOfArrays(objects) {
    let flatObj = {};
    ...
    //     for(const thing in objects[i]){
    //         console.log(thing)
    //         if( thing === 'id' || thing === 'type'){
    //             flatObj[`${thing}`] = objects[i][thing]
    //         }
    //     }
    //     return flatObj;
    // }
    ...
    // let array = Object.keys(object1)
    // console.log(array);
    // for (let i = 0; i < array.length; i++) {
    //     console.log(array[i]);
    //     if (Object.values(object.array)){
    //     console.log(Object.values(object.array));
    //     }
    // }
